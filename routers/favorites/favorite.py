...
from cruds.favorite.favorite import set_favorite, delete_favorite_by_id, get_favorite_by_work_id, get_favorite_by_user_id
...
async def favorite_by_work_id(work_id:str, db: Session = Depends(get_db), user: User = Depends(GetCurrentUser())):
...
async def delete_favorite(work_id:str, db: Session = Depends(get_db), user: User = Depends(GetCurrentUser())):
