...
class TestWork:
    ...
    def test_post_incorrect_type_asset(use_test_db_fixture, user_token_factory_for_test):
        """
        ...
        res = client.post('/api/v1/assets', headers={
                "Authorization": f"Bearer { token.access_token }"
            }, files={
                "file": ("test_image.png", image, 'image/png')
            }, data={
    ...
    def test_post_not_exist_type_asset(use_test_db_fixture, user_token_factory_for_test):
        """
